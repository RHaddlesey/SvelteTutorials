...
<div class="backdrop" class:promo={isPromo} on:click|self>
  <div class="modal">
    <!-- <slot name="title"></slot> = this is a named slot that only renders the slot provided in the APP with the same name. <slot> will render anything passed that is not named -->
    <slot></slot>
